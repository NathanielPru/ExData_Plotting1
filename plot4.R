...
feb2Days$Voltage<-as.numeric(feb2Days$Voltage, na.rm=TRUE)
feb2Days$Global_reactive_power<-as.numeric(feb2Days$Global_reactive_power, na.rm=TRUE)
...
plot(feb2Days$dateTime,feb2Days$Voltage, type = "l"
...
plot(feb2Days$dateTime,feb2Days$Global_reactive_power, type = "l"
